...
Provides details about the various TRMNL models in production. This will soon be used when creating devices and screens.
  ...
  "data": [
    {
      ...
      "width": 800,
      "height": 480,
      "published_at": "2024-06-25 00:00:00 -0600"
    }
  ]
}
----
